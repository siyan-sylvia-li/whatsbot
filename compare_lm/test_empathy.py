...
base_lm = dspy.LM("openai/gpt-4o-mini")

sys.path.insert(1, "/local/data/siyanli/sony_bot/whatsbot")
from empathy_framework import EmpatheticResponder

__location__ = os.path.realpath(
    os.path.join(os.getcwd(), os.path.dirname(__file__)))

MAINTENANCE_PROMPT = open(os.path.join(__location__, "../whatsbot/maintenance_prompt.txt")).read()
